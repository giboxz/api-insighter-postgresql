...
router
  .get(
    "/logmaquinas",
    loginAuth,
    LogMaquinaController.listarLogMaquinaComAnomalia
  )
  .get("/logsmaquinas", loginAuth, LogMaquinaController.listarLogMaquinas)
  .get(
    "/logmaquinas/:id",
    loginAuth,
    LogMaquinaController.listarLogMaquinaPorId
  )
  .get(
    "/logmaquinas/:id/:dataInicio/:dataFim",
    loginAuth,
    LogMaquinaController.listarLogMaquinaPorIdData
  )
